...
u8 scan2_norm_to_keycode[] = {
    /* 0x00 */            0,         KEY_F9,              0,         KEY_F5,         KEY_F3,        KEY_F1,         KEY_F2,     KEY_F12,
    /* 0x08 */            0,        KEY_F10,         KEY_F8,         KEY_F6,         KEY_F4,       KEY_TAB,      KEY_GRAVE,           0,
    /* 0x10 */            0,    KEY_LEFTALT,  KEY_LEFTSHIFT,              0,   KEY_LEFTCTRL,         KEY_Q,          KEY_1,           0,
    /* 0x18 */            0,              0,          KEY_Z,          KEY_S,          KEY_A,         KEY_W,          KEY_2,           0,
    /* 0x20 */            0,          KEY_C,          KEY_X,          KEY_D,          KEY_E,         KEY_4,          KEY_3,           0,
    /* 0x28 */            0,      KEY_SPACE,          KEY_V,          KEY_F,          KEY_T,         KEY_R,          KEY_5,           0,
    /* 0x30 */            0,          KEY_N,          KEY_B,          KEY_H,          KEY_G,         KEY_Y,          KEY_6,           0,
    /* 0x38 */            0,              0,          KEY_M,          KEY_J,          KEY_U,         KEY_7,          KEY_8,           0,
    /* 0x40 */            0,      KEY_COMMA,          KEY_K,          KEY_I,          KEY_O,         KEY_0,          KEY_9,           0,
    /* 0x48 */            0,        KEY_DOT,      KEY_SLASH,          KEY_L,  KEY_SEMICOLON,         KEY_P,      KEY_MINUS,           0,
    /* 0x50 */            0,              0, KEY_APOSTROPHE,              0,  KEY_LEFTBRACE,     KEY_EQUAL,              0,           0,
    /* 0x58 */ KEY_CAPSLOCK, KEY_RIGHTSHIFT,      KEY_ENTER, KEY_RIGHTBRACE,              0, KEY_BACKSLASH,              0,           0,
    /* 0x60 */            0,              0,              0,              0,              0,             0,  KEY_BACKSPACE,           0,
    /* 0x68 */            0,        KEY_KP1,              0,              0,              0,       KEY_KP7,              0,           0,
    /* 0x70 */      KEY_KP0,      KEY_KPDOT,        KEY_KP2,        KEY_KP5,        KEY_KP6,       KEY_KP8,        KEY_ESC, KEY_NUMLOCK,
    /* 0x78 */      KEY_F11,     KEY_KPPLUS,        KEY_KP3,    KEY_KPMINUS, KEY_KPASTERISK,       KEY_KP9, KEY_SCROLLLOCK,           0,
    /* 0x80 */            0,              0,              0,         KEY_F7,
};
u8 scan2_ext_to_keycode[] = {
    /* 0x00 */             0,              0,            0,          0,             0,                0,          0,                    0,
    /* 0x08 */             0,              0,            0,          0,             0,                0,          0,                    0,
    /* 0x10 */       KEY_WWW,   KEY_RIGHTALT,            0,          0, KEY_RIGHTCTRL, KEY_PREVIOUSSONG,          0,                    0,
    /* 0x18 */ KEY_BOOKMARKS,              0,            0,          0,             0,                0,          0,         KEY_LEFTMETA,
    /* 0x20 */   KEY_REFRESH, KEY_VOLUMEDOWN,            0,   KEY_MUTE,             0,                0,          0,        KEY_RIGHTMETA,
    /* 0x28 */      KEY_STOP,              0,     KEY_CALC,          0,             0,                0,          0, KEY_ALL_APPLICATIONS,
    /* 0x30 */   KEY_FORWARD,              0, KEY_VOLUMEUP,          0,      KEY_PLAY,                0,          0,            KEY_POWER,
    /* 0x38 */      KEY_BACK,              0, KEY_HOMEPAGE, KEY_STOPCD,             0,                0,          0,            KEY_SLEEP,
    /* 0x40 */  KEY_COMPUTER,              0,            0,          0,             0,                0,          0,                    0,
    /* 0x48 */     KEY_EMAIL,              0,  KEY_KPSLASH,          0,             0,     KEY_NEXTSONG,          0,                    0,
    /* 0x50 */     KEY_MEDIA,              0,            0,          0,             0,                0,          0,                    0,
    /* 0x58 */             0,              0,  KEY_KPENTER,          0,             0,                0, KEY_WAKEUP,                    0,
    /* 0x60 */             0,              0,            0,          0,             0,                0,          0,                    0,
    /* 0x68 */             0,        KEY_END,            0,   KEY_LEFT,      KEY_HOME,                0,          0,                    0,
    /* 0x70 */    KEY_INSERT,     KEY_DELETE,     KEY_DOWN,          0,     KEY_RIGHT,           KEY_UP,          0,                    0,
    /* 0x78 */             0,              0, KEY_PAGEDOWN,          0,             0,     KEY_PAGEDOWN,          0,                    0,
};
